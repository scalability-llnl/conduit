...
TEST(conduit_exec_accessor, value)
{
...

    {
        ...
        int8_exec_accessor  i8_acc  = n.value();
        int16_exec_accessor i16_acc = n.value();
        int32_exec_accessor i32_acc = n.value();
        int64_exec_accessor i64_acc = n.value();

        uint8_exec_accessor  ui8_acc  = n.value();
        uint16_exec_accessor ui16_acc = n.value();
        uint32_exec_accessor ui32_acc = n.value();
        uint64_exec_accessor ui64_acc = n.value();
        
        
        float32_exec_accessor f32_acc = n.value();
        float64_exec_accessor f64_acc = n.value();
...
TEST(conduit_data_accessor, as_bitwidth_style)
{
    ...
    int8_exec_accessor  i8_acc  = n.as_int8_exec_accessor();
    int16_exec_accessor i16_acc = n.as_int16_exec_accessor();
    int32_exec_accessor i32_acc = n.as_int32_exec_accessor();
    int64_exec_accessor i64_acc = n.as_int64_exec_accessor();

    uint8_exec_accessor  ui8_acc  = n.as_uint8_exec_accessor();
    uint16_exec_accessor ui16_acc = n.as_uint16_exec_accessor();
    uint32_exec_accessor ui32_acc = n.as_uint32_exec_accessor();
    uint64_exec_accessor ui64_acc = n.as_uint64_exec_accessor();
    
    
    float32_exec_accessor f32_acc = n.as_float32_exec_accessor();
    float64_exec_accessor f64_acc = n.as_float64_exec_accessor();
...
TEST(conduit_exec_accessor, as_cstyle)
{
...

    {
        ...
        char_exec_accessor         c_acc  = n.as_char_exec_accessor();
        signed_char_exec_accessor  sc_acc = n.as_signed_char_exec_accessor();
        signed_short_exec_accessor ss_acc = n.as_signed_short_exec_accessor();
        signed_int_exec_accessor   si_acc = n.as_signed_int_exec_accessor();
        signed_long_exec_accessor  sl_acc = n.as_signed_long_exec_accessor();

#ifdef CONDUIT_HAS_LONG_LONG
        signed_long_long_exec_accessor  sll_acc = n.as_signed_long_long_exec_accessor();
#endif

        unsigned_char_exec_accessor  usc_acc = n.as_unsigned_char_exec_accessor();
        unsigned_short_exec_accessor uss_acc = n.as_unsigned_short_exec_accessor();
        unsigned_int_exec_accessor   usi_acc = n.as_unsigned_int_exec_accessor();
        unsigned_long_exec_accessor  usl_acc = n.as_unsigned_long_exec_accessor();

#ifdef CONDUIT_HAS_LONG_LONG
        unsigned_long_long_exec_accessor  usll_acc = n.as_unsigned_long_long_exec_accessor();
#endif

        float_exec_accessor  f_acc = n.as_float_exec_accessor();
        double_exec_accessor d_acc = n.as_double_exec_accessor();

#ifdef CONDUIT_USE_LONG_DOUBLE
        long_double_exec_accessor  ld_acc = n.as_long_double_exec_accessor();
#endif
...
TEST(conduit_exec_accessor, set_using_data_array)
{
    ...
    n["vint8"].as_int8_exec_accessor().set(va_int8);
    ...
    n["vint16"].as_int16_exec_accessor().set(va_int16);
    ...
    n["vint32"].as_int32_exec_accessor().set(va_int32);
    ...
    n["vint64"].as_int64_exec_accessor().set(va_int64);
    ...
    n["vuint8"].as_uint8_exec_accessor().set(va_uint8);
    ...
    n["vuint16"].as_uint16_exec_accessor().set(va_uint16);
    ...
    n["vuint32"].as_uint32_exec_accessor().set(va_uint32);
    ...
    n["vuint64"].as_uint64_exec_accessor().set(va_uint64);
    ...
    n["vfloat32"].as_float32_exec_accessor().set(va_float32);
    ...
    n["vfloat64"].as_float64_exec_accessor().set(va_float64);
...
TEST(conduit_exec_accessor, set_using_data_accessor)
{
    ...
    // int8_array
    n["vint8"].set(DataType::int8(10));
    n["vint8"].as_int8_exec_accessor().set(vacc_int8);
    int8 *n_int8_ptr = n["vint8"].value();
    for(index_t i=0;i<10;i++)
    {
    ...
    // int16_array
    n["vint16"].set(DataType::int16(10));
    n["vint16"].as_int16_exec_accessor().set(vacc_int16);
    int16 *n_int16_ptr = n["vint16"].value();
    for(index_t i=0;i<10;i++)
    {
    ...
    // int32_array
    n["vint32"].set(DataType::int32(10));
    n["vint32"].as_int32_exec_accessor().set(vacc_int32);
    int32 *n_int32_ptr = n["vint32"].value();
    for(index_t i=0;i<10;i++)
    {
    ...
    // int64_array
    n["vint64"].set(DataType::int64(10));
    n["vint64"].as_int64_exec_accessor().set(vacc_int64);
    int64 *n_int64_ptr = n["vint64"].value();
    for(index_t i=0;i<10;i++)
    {
    ...
    // uint8_array
    n["vuint8"].set(DataType::uint8(10));
    n["vuint8"].as_uint8_exec_accessor().set(vacc_uint8);
    uint8 *n_uint8_ptr = n["vuint8"].value();
    for(index_t i=0;i<10;i++)
    {
    ...
    // uint16_array
    n["vuint16"].set(DataType::uint16(10));
    n["vuint16"].as_uint16_exec_accessor().set(vacc_uint16);
    uint16 *n_uint16_ptr = n["vuint16"].value();
    for(index_t i=0;i<10;i++)
    {
    ...
    // uint32_array
    n["vuint32"].set(DataType::uint32(10));
    n["vuint32"].as_uint32_exec_accessor().set(vacc_uint32);
    uint32 *n_uint32_ptr = n["vuint32"].value();
    for(index_t i=0;i<10;i++)
    {
    ...
    // uint64_array
    n["vuint64"].set(DataType::uint64(10));
    n["vuint64"].as_uint64_exec_accessor().set(vacc_uint64);
    uint64 *n_uint64_ptr = n["vuint64"].value();
    for(index_t i=0;i<10;i++)
    {
    ...
    // float32_array
    n["vfloat32"].set(DataType::float32(10));
    n["vfloat32"].as_float32_exec_accessor().set(vacc_float32);
    float32 *n_float32_ptr = n["vfloat32"].value();
    for(index_t i=0;i<10;i++)
    {
    ...
    // float64_array
    n["vfloat64"].set(DataType::float64(10));
    n["vfloat64"].as_float64_exec_accessor().set(vacc_float64);
    float64 *n_float64_ptr = n["vfloat64"].value();
    for(index_t i=0;i<10;i++)
    {
