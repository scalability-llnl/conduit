...
# of the sidebar.
html_logo = "conduit_logo_white_small.svg"
...
latex_documents = [
  ('index', 'Conduit.tex', u'Conduit Documentation',
   u'LLNS', 'manual'),
]
...
man_pages = [
    ('index', 'conduit', u'Conduit Documentation',
     [u'LLNS'], 1)
]
...
texinfo_documents = [
  ('index', 'Conduit', u'Conduit Documentation',
   u'LLNS', 'Conduit', 'Simplified Data Exchange for HPC Simulations',
   'Miscellaneous'),
]
